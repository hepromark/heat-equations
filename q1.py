...
plt.suptitle('Chicken Egg Temperature Profile')
plt.savefig('./plots/1_chicken_egg_temperature_profile.png', dpi=300)
plt.tight_layout()
plt.show()
...
plt.suptitle('Quail Egg Temperature Profile')
plt.savefig('./plots/1_quail_egg_temperature_profile.png', dpi=300)
plt.tight_layout()
plt.show()
...
plt.suptitle('Ostrich Egg Temperature Profile')
plt.savefig('./plots/1_ostrich_egg_temperature_profile.png', dpi=300)
plt.tight_layout()
plt.show()
